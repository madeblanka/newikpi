...
class Anggota extends CI_Controller
{
	...
	{
		$data['anggota'] = $this->anggota->getbyId($this->input->post('nra'));
		if($data!=null)
		{
			$this->load->view('admin/setpass',$data);
		}else
		{
			echo "<script>
	...
	{
		$a = $this->anggota->updatepass($this->input->post('nra'));
		if($a)
		{
			echo "<script>
		...
		{
			echo "<script>
				alert('Password Gagal Diperbaharui! Silahkan Hubungi Admin);
				window.location.href='';
				</script>";
		}
	}
	...
	public function editpengurus($nra)
	{
		$data['pengurus'] = $this->pengurus->getbyId($nra);
		$this->load->view('admin/pengurus/edit',$data);
	}

	public function updatepengurus()
	{
		$this->pengurus->update($this->input->post('nra'));
		redirect('anggota/pengurus');

	}
	public function pengurus()
	{
		$data['pengurus'] = $this->pengurus->getAll();
		$this->load->view('admin/pengurus/index',$data);
	}

	public function deletepengurus($nra)
	{
		$this->pengurus->delete($nra);
		redirect('anggota/pengurus');
	}

	public function notifikasi()
	{
		$data["notifikasi"] = $this->notifikasi->getAll();
		$this->load->view('admin/notifikasi/index',$data);
	}

	public function editnotifikasi($id)
	{
		$data["notifikasi"] = $this->notifikasi->getbyId($id);
		$this->load->view('admin/notifikasi/edit',$data);
	}
	...
	public function addnotifikasi()
	{
		if ($this->input->post()) {
			$this->notifikasi->save();
				redirect('anggota/notifikasi');
			} else {
				$this->load->view('admin/notifikasi/add');
		}
	}

	public function updatenotifikasi()
	{
		$this->notifikasi->update($this->post->nama);
		redirect('anggota/notifikasi');
	}

	public function cover()
	{
		$data["cover"] = $this->cover->getAll();
		$this->load->view('admin/cover/index',$data);
	}

	public function addcover()
	{
		$this->load->view('admin/cover/add');		
	}

	public function adddcover()
	{
		$this->cover->save();
		redirect('anggota/cover');
	}
	...
	{
		$data["cover"] = $this->cover->getbyId($id);
		$this->load->view('admin/cover/edit',$data);
	}
	...
	{
		$data["about"] = $this->about->getbyId($id);
