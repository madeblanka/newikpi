      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            ...
            <form action="<?php echo site_url('anggota/addpengurus') ?>" method="post" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Nama Anggota</label>
                    <select class="form-control" name="nra">
                        <?php foreach($anggota as $a):?>
                        <option value="<?= $a->nra?>"><?= $this->anggota->getbyId($a->nra)->nama?></option>
                        <?php endforeach?>
                    </select>
                </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="date" name="tahun_jabatan" class="form-control" id="exampleInputPassword1">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Tahun Berahir</label>
                    <input type="date" name="tahun_berahir" class="form-control" id="exampleInputPassword1">
                  </div>
                </div>
                <!-- /.card-body -->
