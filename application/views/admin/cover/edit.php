      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            ...
            <form action="<?php echo site_url('anggota/updatecover') ?>" method="post" enctype="multipart/form-data">
                <!-- <?php foreach($cover as $c):?> -->
                  <input type="hidden" value="<?= $cover->id?>" name="id">
                <!-- <?php endforeach?> -->
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputPassword1">Cover</label>
                    <input type="file" name="c1" class="form-control" id="exampleInputPassword1">
                  </div>
                </div>
                <!-- /.card-body -->
