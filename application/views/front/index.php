  ...
  <section id="about" class="about section-bg">
    <div class="container" data-aos="fade-up">
      ...
      <div class="section-title">
        <h3>Beranda <span style="color:green"> IKPI Bali</span></h3>
        <p><br></p>
      </div>
        ...
        <div class="col-lg-3">
          ...
          <div class="card text-center shadow">
                ...
                <li class="list-group-item" style="text-align:left;">
                  <div class="row">
                    <div class="col-9" style="font-size: 13px;">
                      Peraturan - <strong><a style="color: green" href="<?= site_url('front/peraturandetail/' . $p->id_peraturan) ?>"><?= $p->nama ?></a></strong>
                    </div>
            ...
            <div class="card-footer text-white py-3" style="font-size: 14px; text-align: right;">
              <strong><a style="color: gold" href="<?= site_url('front/peraturanlist/') ?>">Lihat Semua</a></strong>
            </div>
          </div>
        </div>
        <div class="col-lg-6">
          ...
          <table class="table table-bordered bg-white shadow" style="margin:0;">
            <tbody>
              ...
              <tr>
                  <td>
                    <img src="<?= base_url('postingan/' . $p->gambar1) ?>" class="img-fluid" >
                    <p style="font-size: 16px; margin:0;">
                      <a style="color: black" href="<?= site_url('front/detailpostingan/' . $p->id_postingan) ?>"><i><?php echo date('d M Y', strtotime($p->tanggal)) ?> : </i></a><strong><a style="color: green" href="<?= site_url('front/detailpostingan/' . $p->id_postingan) ?>"> <?= $p->nama ?> </a> </strong>
                    </p>
                  </td>
                </tr>
                <?php endforeach ?>
          ...
          <div class="card-footer text-white py-3" style="font-size: 14px; text-align: right;">
            <strong><a style="color: gold" href="<?= site_url('front/postinganlist/') ?>">Lihat Semua</a></strong>
          </div>
        </div>

        <div class="col-lg-3">
          <h3>INFO ANGGOTA IKPI</h3>
          <div class="card text-center shadow">
            <ul class="list-group list-group-flush">
              <?php foreach ($anggota as $a) : ?>
                <li class="list-group-item" style="text-align:left;">
                  <div class="row">
                    <div class="col-9" style="font-size: 13px;">
                      Nama : <strong><a style="color: green" href="<?= site_url('front/anggotadetail/' . $a->nra) ?>"><?= $a->nama ?></a></strong>
                    </div>
                    <div class="col-3 text-muted" style="font-size: 12px; ">
            ...
            <div class="card-footer text-white py-3" style="font-size: 14px; text-align: right;">
              <strong><a style="color: gold"href="<?= site_url('front/anggotalist') ?>">Lihat Semua</a></strong>
            </div>
          </div>
        </div>
      </div>
  ...
  <div id="myModal" class="modal fade" role="dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title"><?= $n->nama?></h5>
      </div>
