  ...
  <section id="about" class="about section-bg">
    <div class="container" data-aos="fade-up">
      ...
      <div class="section-title">
        <h3>Kegiatan <span> IKPI Bali</span></h3>
        <p><br></p>
      </div>

      <div class="row">
        <div class="col">
          <h3>List Kegiatan <?= (isset($tahunaktif)) ? $tahunaktif : ''; ?></h3>
                ...
                <li class="list-group-item" style="text-align:left;">
                  <div class="row">
                    ...
                    <div class="col-3 text-muted" style="font-size: 12px; ">
                      <!-- <i>Tanggal : <?php //echo date('d-M-Y H:i', strtotime($p->created_at)) 
                                        ?></i> -->
                      <i>Tanggal : <?= date('d-M-Y', strtotime($p->tanggal)) ?></i>
                    </div>
                  </div>
                </li>
              <?php endforeach ?>
