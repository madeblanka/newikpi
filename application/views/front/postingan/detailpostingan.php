          ...
          <div class="row gy-4">
                ...
                <div class="swiper-wrapper align-items-center">
                  ...
                  ?>
                      <div class="swiper-slide">
                        <div class="title" data-swiper-parallax="-100" align="center"><h5 style="font-size:20px"><?= $p[$temp_keterangan] ?></h5>
                        </div>
            ...
            <div class="col-lg-4">
              <div class="portfolio-info">
                <h3><?= $p['nama'] ?></h3>
                <ul>
                  <li><strong>Tanggal Event</strong>: <?= date_format(date_create($p['tanggal']),'d-M-Y') ?></li>
