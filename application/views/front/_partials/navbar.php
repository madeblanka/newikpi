...
<header id="header" class="d-flex align-items-center">
  <div class="container d-flex align-items-center justify-content-between">
    ...
    <h1 class="logo"><a href="<?= site_url('') ?>">IKPI Bali<span style="color:green">.</span></a></h1>
    ...
    <nav id="navbar" class="navbar">
      <ul>
        ...
        <li class="dropdown"><a href="#"><span>Profil</span> <i class="bi bi-chevron-down"></i></a>
          <ul>
            <li><a href="<?= site_url('front/aboutus/') ?>">Tentang Kami</a></li>
            <li><a href="<?= site_url('front/pengurus/') ?>">Pengurus</a></li>
            <li><a href="<?= site_url('front/anggotalist/') ?>">Anggota</a></li>
          </ul>
        </li>
      ...
      <li class="dropdown"><a href="#"><span>PPL</span> <i class="bi bi-chevron-down"></i></a>
        ...
        <?php if ($this->session->userdata('role')) { ?>
          <?php if ($this->session->userdata('role') == 'Anggota') { ?>
            ...
            <li><a class="nav-link scrollto" href="<?= site_url('anggota/postingan') ?>">Profile Diri</a></li>
          <?php } else { ?>
        ...
        <li class="dropdown"><a href="#"><span>Register</span> <i class="bi bi-chevron-down"></i></a>
          <ul>
            <li><a href="<?= site_url('anggota/register/') ?>">Anggota IKPI</a></li>
            <li><a href="<?= site_url('member/register/') ?>">Umum</a></li>
          </ul>
        </li>
        <?php } ?>
      </ul>
